...
public class AlGathorStatueModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "algathorstatuemodel"), "main");
	...
	private final ModelPart kilt;
	private final ModelPart torso;
	private final ModelPart arm_l;
	private final ModelPart arm_r;
	private final ModelPart head_root;
	private final ModelPart head;
	private final ModelPart jaw;
	private final ModelPart nemes;
	private final ModelPart tail;

	public AlGathorStatueModel(ModelPart root) {
		this.al_gathor = root.getChild("al_gathor");
		this.pedestal = this.al_gathor.getChild("pedestal");
		this.foot_l = this.al_gathor.getChild("foot_l");
		this.foot_r = this.al_gathor.getChild("foot_r");
		this.body = this.al_gathor.getChild("body");
		this.kilt = this.body.getChild("kilt");
		this.torso = this.body.getChild("torso");
		this.arm_l = this.body.getChild("arm_l");
		this.arm_r = this.body.getChild("arm_r");
		this.head_root = this.body.getChild("head_root");
		this.head = this.head_root.getChild("head");
		this.jaw = this.head.getChild("jaw");
		this.nemes = this.head_root.getChild("nemes");
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		al_gathor.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}